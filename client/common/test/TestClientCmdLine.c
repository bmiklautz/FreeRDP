...
static test tests[] = {
	{ COMMAND_LINE_STATUS_PRINT_HELP, check_settings_smartcard_no_redirection, { "xfreerdp", "--help", 0 }, { { 0 } } },
	{ COMMAND_LINE_STATUS_PRINT_HELP, check_settings_smartcard_no_redirection, { "xfreerdp", "/help", 0 }, { { 0 } } },
	{ COMMAND_LINE_STATUS_PRINT_HELP, check_settings_smartcard_no_redirection, { "xfreerdp", "-help", 0 }, { { 0 } } },
	...
	{ COMMAND_LINE_STATUS_PRINT_VERSION,
	  ...
	  { "xfreerdp", "-version", 0 },
	  { { 0 } } },
	{ 0, check_settings_smartcard_no_redirection, { "xfreerdp", "test.freerdp.com", 0 }, { { 0 } } },
	{ 0, check_settings_smartcard_no_redirection, { "xfreerdp", "-v", "test.freerdp.com", 0 }, { { 0 } } },
	{ 0, check_settings_smartcard_no_redirection, { "xfreerdp", "--v", "test.freerdp.com", 0 }, { { 0 } } },
	{ 0, check_settings_smartcard_no_redirection, { "xfreerdp", "/v:test.freerdp.com", 0 }, { { 0 } } },
	{ 0,
	  check_settings_smartcard_no_redirection,
	  { "xfreerdp", "--plugin", "rdpsnd", "--plugin", "rdpdr", "--data", "disk:media:" DRIVE_REDIRECT_PATH, "--",
	    "test.freerdp.com", 0 },
	  { { 0 } } },
	{ 0,
	  check_settings_smartcard_no_redirection,
	...
	{ COMMAND_LINE_ERROR_NO_KEYWORD,
	  ...
	  { "xfreerdp", "--invalid", 0 },
	  { { 0 } } },
	{ COMMAND_LINE_STATUS_PRINT, check_settings_smartcard_no_redirection, { "xfreerdp", "/kbd-list", 0 }, { { 0 } } },
...
int TestClientCmdLine(int argc, char* argv[])
{
	...
	for (i = 0; i < sizeof(tests) / sizeof(tests[0]); i++)
	{
		...
		if (!testcase(__FUNCTION__, command_line, string_list_length((const char* const*) command_line),
