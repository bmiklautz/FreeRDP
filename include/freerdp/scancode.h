 ...
 * The server accepts a scancode value and translates it into the correct character depending on the language locale and
 * keyboard layout used in the session." The 8-bit value is later called "keyCode" The extended flag is for all
 * practical an important 9th bit with a strange encoding - not just a modifier.
 */
...
#define RDP_SCANCODE_NUMLOCK                                                                                           \
	...
	/* VK_NUMLOCK */ /* Note: when this seems to appear in PKBDLLHOOKSTRUCT it means Pause which must be sent as Ctrl  \
	                    + NumLock */
