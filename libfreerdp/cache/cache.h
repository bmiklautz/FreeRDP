...
FREERDP_LOCAL void free_cache_color_table_order(rdpContext* context, CACHE_COLOR_TABLE_ORDER* order);

FREERDP_LOCAL SURFACE_BITS_COMMAND* copy_surface_bits_command(rdpContext* context, const SURFACE_BITS_COMMAND* order);
