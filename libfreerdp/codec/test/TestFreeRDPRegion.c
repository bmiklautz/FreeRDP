...
static BOOL compareRectangles(const RECTANGLE_16* src1, const RECTANGLE_16* src2, int nb)
{
	...
	for (i = 0; i < nb; i++, src1++, src2++)
	{
		...
		{
			fprintf(stderr,
			        "expecting rect %d (%" PRIu16 ",%" PRIu16 "-%" PRIu16 ",%" PRIu16 ") and have (%" PRIu16 ",%" PRIu16
			        "-%" PRIu16 ",%" PRIu16 ")\n",
			        i, src2->left, src2->top, src2->right, src2->bottom, src1->left, src1->top, src1->right,
			        src1->bottom);
			return FALSE;
		}
	}
...
static int test_r1_r2_r3_r4(void)
{
	...
	RECTANGLE_16 r1_r2_r3_r4[] = { { 0, 101, 200, 151 }, { 0, 151, 250, 201 }, { 150, 201, 250, 401 } };
	region16_init(&region);
