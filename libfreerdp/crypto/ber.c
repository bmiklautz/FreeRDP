...
size_t ber_sizeof_contextual_tag(size_t length) { return 1 + _ber_sizeof_length(length); }
...
size_t ber_sizeof_sequence(size_t length) { return 1 + _ber_sizeof_length(length) + length; }

size_t ber_sizeof_sequence_tag(size_t length) { return 1 + _ber_sizeof_length(length); }
...
size_t ber_sizeof_octet_string(size_t length) { return 1 + _ber_sizeof_length(length) + length; }
