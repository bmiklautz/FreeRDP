...
void stopwatch_free(STOPWATCH* stopwatch) { free(stopwatch); }
...
double stopwatch_get_elapsed_time_in_seconds(STOPWATCH* stopwatch) { return (stopwatch->elapsed / 1000000.0); }
