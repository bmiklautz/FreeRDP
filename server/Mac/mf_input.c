...
BOOL mf_input_unicode_keyboard_event(rdpInput* input, UINT16 flags, UINT16 code) { return FALSE; }
...
BOOL mf_input_mouse_event(rdpInput* input, UINT16 flags, UINT16 x, UINT16 y)
{
	...
	if (flags & (PTR_FLAGS_WHEEL | PTR_FLAGS_HWHEEL))
	{
		...
		CGEventRef scrollEvent =
		  CGEventCreateScrollWheelEvent(source, kCGScrollEventUnitLine, wheelCount, scroll_y, scroll_x);
...
BOOL mf_input_extended_mouse_event(rdpInput* input, UINT16 flags, UINT16 x, UINT16 y) { return FALSE; }

BOOL mf_input_keyboard_event_dummy(rdpInput* input, UINT16 flags, UINT16 code) { return FALSE; }

BOOL mf_input_unicode_keyboard_event_dummy(rdpInput* input, UINT16 flags, UINT16 code) { return FALSE; }

BOOL mf_input_mouse_event_dummy(rdpInput* input, UINT16 flags, UINT16 x, UINT16 y) { return FALSE; }

BOOL mf_input_extended_mouse_event_dummy(rdpInput* input, UINT16 flags, UINT16 x, UINT16 y) { return FALSE; }
