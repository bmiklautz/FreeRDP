 ...
 */
UWAC_API UwacReturnCode UwacDisplayQueryInterfaceVersion(const UwacDisplay* display, const char* name,
                                                         uint32_t* version);
 ...
 */
UWAC_API UwacReturnCode UwacDisplayQueryShmFormats(const UwacDisplay* display, enum wl_shm_format* formats,
 ...
 * @return the given UwacOutput, NULL if something failed (so you should query UwacDisplayGetLastError() to have the
 *reason)
 */
 ...
 * @return UWAC_SUCCESS on success, an error otherwise
 */
UWAC_API UwacReturnCode UwacWindowSetOpaqueRegion(UwacWindow* window, uint32_t x, uint32_t y, uint32_t width,
                                                  uint32_t height);
 ...
 * @return
 */
UWAC_API UwacReturnCode UwacWindowSetInputRegion(UwacWindow* window, uint32_t x, uint32_t y, uint32_t width,
                                                 uint32_t height);
 ...
 */
UWAC_API UwacReturnCode UwacWindowAddDamage(UwacWindow* window, uint32_t x, uint32_t y, uint32_t width,
                                            uint32_t height);
