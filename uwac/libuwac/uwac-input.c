...
static const struct wl_keyboard_listener keyboard_listener = { keyboard_handle_keymap,    keyboard_handle_enter,
...
static const struct wl_touch_listener touch_listener = {
	touch_handle_down, touch_handle_up, touch_handle_motion, touch_handle_frame, touch_handle_cancel,
};
...
static void pointer_handle_motion(void* data, struct wl_pointer* pointer, uint32_t time, wl_fixed_t sx_w,
                                  wl_fixed_t sy_w)
{
...
static void pointer_frame(void* data, struct wl_pointer* wl_pointer) { /*UwacSeat *seat = data;*/ }
...
const char* UwacSeatGetName(const UwacSeat* seat) { return seat->name; }

UwacSeatId UwacSeatGetId(const UwacSeat* seat) { return seat->seat_id; }
