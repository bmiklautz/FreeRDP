...
#define Data_Read_UINT32(_d, _v)                                                                                       \
	...
	{                                                                                                                  \
		_v = (UINT32)(*((const BYTE*) _d)) + (((UINT32)(*((const BYTE*) _d + 1))) << 8) +                              \
		  (((UINT32)(*((const BYTE*) _d + 2))) << 16) + (((UINT32)(*((const BYTE*) _d + 3))) << 24);                   \
	} while (0)
...
#define Data_Read_UINT64(_d, _v)                                                                                       \
	...
	{                                                                                                                  \
		_v = (UINT64)(*((const BYTE*) _d)) + (((UINT64)(*((const BYTE*) _d + 1))) << 8) +                              \
		  (((UINT64)(*((const BYTE*) _d + 2))) << 16) + (((UINT64)(*((const BYTE*) _d + 3))) << 24) +                  \
		  (((UINT64)(*((const BYTE*) _d + 4))) << 32) + (((UINT64)(*((const BYTE*) _d + 5))) << 40) +                  \
		  (((UINT64)(*((const BYTE*) _d + 6))) << 48) + (((UINT64)(*((const BYTE*) _d + 7))) << 56);                   \
	} while (0)
