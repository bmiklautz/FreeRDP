...
static INLINE UINT32 __lzcnt(UINT32 _val32) { return ((UINT32) __builtin_clz(_val32)); }

static INLINE UINT16 __lzcnt16(UINT16 _val16) { return ((UINT16)(__builtin_clz((UINT32) _val16) - 16)); }
...
static INLINE UINT16 __lzcnt16(UINT16 x) { return ((UINT16) __lzcnt((UINT32) x)); }
