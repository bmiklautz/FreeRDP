...
int TestCredUIParseUserName(int argc, char* argv[])
{
	...
	status =
	  CredUIParseUserName(testUserName1, User, sizeof(User) / sizeof(TCHAR), Domain, sizeof(Domain) / sizeof(TCHAR));
	...
	status =
	  CredUIParseUserName(testUserName2, User, sizeof(User) / sizeof(TCHAR), Domain, sizeof(Domain) / sizeof(TCHAR));
