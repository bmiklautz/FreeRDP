...
static CREDUI_INFO testUiInfo = { sizeof(CREDUI_INFO), NULL, _T("Message Text"), _T("Caption Text"), NULL };
...
int TestCredUIPromptForCredentials(int argc, char* argv[])
{
	...
	status = CredUIPromptForCredentials(&testUiInfo, testTargetName, NULL, 0, UserName, CREDUI_MAX_USERNAME_LENGTH,
