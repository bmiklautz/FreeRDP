...
int TestFormatSpecifiers(int argc, char* argv[])
{
	...
	/* size_t */
	{
		...
		sprintf_s(fmt, sizeof(fmt), "uz:%" PRIuz " oz:%" PRIoz " xz:%" PRIxz " Xz:%" PRIXz "", arg, arg, arg, arg);
	...
	/* INT8 */
	{
		...
		sprintf_s(fmt, sizeof(fmt), "d8:%" PRId8 " x8:%" PRIx8 " X8:%" PRIX8 "", arg, (UINT8) arg, (UINT8) arg);
	...
	/* UINT8 */
	{
		...
		sprintf_s(fmt, sizeof(fmt), "u8:%" PRIu8 " o8:%" PRIo8 " x8:%" PRIx8 " X8:%" PRIX8 "", arg, arg, arg, arg);
	...
	/* INT16 */
	{
		...
		sprintf_s(fmt, sizeof(fmt), "d16:%" PRId16 " x16:%" PRIx16 " X16:%" PRIX16 "", arg, (UINT16) arg, (UINT16) arg);
	...
	/* UINT16 */
	{
		...
		sprintf_s(fmt, sizeof(fmt), "u16:%" PRIu16 " o16:%" PRIo16 " x16:%" PRIx16 " X16:%" PRIX16 "", arg, arg, arg,
		          arg);
	...
	/* INT32 */
	{
		...
		sprintf_s(fmt, sizeof(fmt), "d32:%" PRId32 " x32:%" PRIx32 " X32:%" PRIX32 "", arg, (UINT32) arg, (UINT32) arg);
	...
	/* UINT32 */
	{
		...
		sprintf_s(fmt, sizeof(fmt), "u32:%" PRIu32 " o32:%" PRIo32 " x32:%" PRIx32 " X32:%" PRIX32 "", arg, arg, arg,
		          arg);
	...
	/* INT64 */
	{
		...
		sprintf_s(fmt, sizeof(fmt), "d64:%" PRId64 " x64:%" PRIx64 " X64:%" PRIX64 "", arg, (UINT64) arg, (UINT64) arg);
	...
	/* UINT64 */
	{
		...
		sprintf_s(fmt, sizeof(fmt), "u64:%" PRIu64 " o64:%" PRIo64 " x64:%016" PRIx64 " X64:%016" PRIX64 "", arg, arg,
		          arg, arg);
