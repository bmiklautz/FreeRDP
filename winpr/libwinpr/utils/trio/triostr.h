...
#if defined(TRIO_FUNC_DUPLICATE) || defined(TRIO_FUNC_DUPLICATE_MAX) || defined(TRIO_FUNC_STRING_DUPLICATE) ||         \
...
#if defined(TRIO_FUNC_EQUAL_LOCALE) || defined(TRIO_FUNC_STRING_EQUAL) || defined(TRIO_FUNC_XSTRING_EQUAL)
#if !defined(TRIO_FUNC_EQUAL)
#define TRIO_FUNC_EQUAL
#endif
#endif

#if defined(TRIO_FUNC_EQUAL_CASE) || defined(TRIO_FUNC_STRING_EQUAL_CASE) || defined(TRIO_FUNC_XSTRING_EQUAL_CASE)
#if !defined(TRIO_FUNC_EQUAL_CASE)
#define TRIO_FUNC_EQUAL_CASE
#endif
#endif

#if defined(TRIO_FUNC_SUBSTRING_MAX) || defined(TRIO_FUNC_STRING_EQUAL_MAX) || defined(TRIO_FUNC_XSTRING_EQUAL_MAX)
...
#if defined(TRIO_FUNC_COPY_MAX)
TRIO_PUBLIC_STRING int trio_copy_max TRIO_PROTO((char* target, size_t max, TRIO_CONST char* source));
#endif
...
#if defined(TRIO_FUNC_EQUAL_CASE)
TRIO_PUBLIC_STRING int trio_equal_case TRIO_PROTO((TRIO_CONST char* first, TRIO_CONST char* second));
#endif
...
TRIO_PUBLIC_STRING int trio_equal_locale TRIO_PROTO((TRIO_CONST char* first, TRIO_CONST char* second));
#endif

#if defined(TRIO_FUNC_EQUAL_MAX)
TRIO_PUBLIC_STRING int trio_equal_max TRIO_PROTO((TRIO_CONST char* first, size_t max, TRIO_CONST char* second));
#endif
...
TRIO_PUBLIC_STRING size_t trio_format_date_max TRIO_PROTO((char* target, size_t max, TRIO_CONST char* format,
...
TRIO_PUBLIC_STRING int trio_match_case TRIO_PROTO((TRIO_CONST char* string, TRIO_CONST char* pattern));
#endif
...
TRIO_PUBLIC_STRING char* trio_substring TRIO_PROTO((TRIO_CONST char* string, TRIO_CONST char* substring));
#endif
...
#if defined(TRIO_FUNC_TO_LONG_DOUBLE)
TRIO_PUBLIC_STRING trio_long_double_t trio_to_long_double TRIO_PROTO((TRIO_CONST char* source, char** endp));
#endif

#if defined(TRIO_FUNC_TO_UNSIGNED_LONG)
TRIO_PUBLIC_STRING unsigned long trio_to_unsigned_long TRIO_PROTO((TRIO_CONST char* source, char** endp, int base));
#endif
...
TRIO_PUBLIC_STRING int trio_string_contains TRIO_PROTO((trio_string_t * self, trio_string_t* other));
#endif

#if defined(TRIO_FUNC_STRING_COPY)
TRIO_PUBLIC_STRING int trio_string_copy TRIO_PROTO((trio_string_t * self, trio_string_t* other));
#endif
...
TRIO_PUBLIC_STRING int trio_string_equal TRIO_PROTO((trio_string_t * self, trio_string_t* other));
#endif
...
TRIO_PUBLIC_STRING int trio_string_equal_case TRIO_PROTO((trio_string_t * self, trio_string_t* other));
#endif
...
TRIO_PUBLIC_STRING size_t trio_string_format_date_max TRIO_PROTO((trio_string_t * self, size_t max,
...
TRIO_PUBLIC_STRING char* trio_string_index_last TRIO_PROTO((trio_string_t * self, int character));
#endif
...
TRIO_PUBLIC_STRING int trio_string_match TRIO_PROTO((trio_string_t * self, trio_string_t* other));
#endif

#if defined(TRIO_FUNC_STRING_MATCH_CASE)
TRIO_PUBLIC_STRING int trio_string_match_case TRIO_PROTO((trio_string_t * self, trio_string_t* other));
#endif
...
TRIO_PUBLIC_STRING char* trio_string_substring TRIO_PROTO((trio_string_t * self, trio_string_t* other));
#endif
...
TRIO_PUBLIC_STRING int trio_xstring_contains TRIO_PROTO((trio_string_t * self, TRIO_CONST char* other));
#endif

#if defined(TRIO_FUNC_XSTRING_COPY)
TRIO_PUBLIC_STRING int trio_xstring_copy TRIO_PROTO((trio_string_t * self, TRIO_CONST char* other));
#endif
...
TRIO_PUBLIC_STRING int trio_xstring_equal TRIO_PROTO((trio_string_t * self, TRIO_CONST char* other));
#endif
...
TRIO_PUBLIC_STRING int trio_xstring_equal_case TRIO_PROTO((trio_string_t * self, TRIO_CONST char* other));
#endif
...
TRIO_PUBLIC_STRING int trio_xstring_match TRIO_PROTO((trio_string_t * self, TRIO_CONST char* other));
#endif

#if defined(TRIO_FUNC_XSTRING_MATCH_CASE)
TRIO_PUBLIC_STRING int trio_xstring_match_case TRIO_PROTO((trio_string_t * self, TRIO_CONST char* other));
#endif
...
TRIO_PUBLIC_STRING char* trio_xstring_substring TRIO_PROTO((trio_string_t * self, TRIO_CONST char* other));
#endif
